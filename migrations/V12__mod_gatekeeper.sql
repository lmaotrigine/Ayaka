-- Revises: V11
-- Creation Date: 2024-02-06 07:00:06.820288 UTC
...
CREATE TABLE IF NOT EXISTS guild_gatekeeper (
  ...
  started_at TIMESTAMP WITH TIME ZONE CHECK (started_at IS NULL OR (channel_id IS NOT NULL AND role_id IS NOT NULL AND message_id IS NOT NULL)),
  channel_id BIGINT,
  role_id BIGINT,
  message_id BIGINT,
