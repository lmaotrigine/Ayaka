...
async def plonk_iterator(bot: Ayaka, guild: discord.Guild, records: list[Record]) -> AsyncIterator[str]:
...
class Config(commands.Cog):
    ...
    async def unignore(self, ctx: GuildContext, *entities: discord.TextChannel | discord.Member | discord.VoiceChannel):
        ...
        To use this command you must have the Ban Members and Manage Messages permission.
        """
